            ...
            if (interaction.customId === `lspdmodal`) {
                ...
                const queryresult = () => {
                    return new Promise((resolve, reject)=>{
                        db.query("SELECT clockin FROM hours WHERE clockout IS NULL", (err, result) => {
                        if (err) throw err;
                ...
                if (dbclockin === undefined) await interaction.reply('You no clock in you buffooon');
                ...
                const sql = `UPDATE hours SET clockout='${clockout}', total_time='${totaltime}' WHERE clockout IS NULL`;
